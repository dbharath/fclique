...
*/
            ...
            synchronized(UtilDateTime.class) {
                if (availableTimeZoneList == null) {
                    ...
                    if (UtilValidate.isNotEmpty(tzString)) {
                        idList = Arrays.asList(tzString.split(","));
                    } else {
    ...
    public static Date getDateBeforeAMonth() {
    ...
    public static Timestamp getTimestampBeforeAMonth() {    
    	return new Timestamp(getDateBeforeAMonth().getTime());
    }
    
    public static Timestamp getTimestampBeforeAWeek() {
    	Calendar calNow = Calendar.getInstance();        	
    	calNow.add(Calendar.DAY_OF_MONTH, -7);
    	Date dateBeforeAWeek = calNow.getTime();    	
    	return new Timestamp(dateBeforeAWeek.getTime());
    } 
    /***
     * 
     * @param stamp
     ...
     * @return String
     */
    public static String parseTimestampToString(Timestamp stamp,String dateFormat) {
     ...
     * @return boolean
     */
    public static boolean timestampIsGreater(Timestamp timestamp1, Timestamp timestamp2){
    	return (timestamp1.compareTo(timestamp2)==1);
    }
    ...
    /*public static void main(String asp[]){
    	System.out.println(getDayEnd(UtilDateTime.nowTimestamp(), Long.valueOf(1)).getTime());
    	System.out.println(UtilDateTime.adjustTimestamp(UtilDateTime.nowTimestamp(), java.util.Calendar.DATE, -6));
    	
    	System.out.println(UtilDateTime.adjustTimestamp(UtilDateTime.getDayEnd(UtilDateTime.nowTimestamp()), java.util.Calendar.MINUTE, -1));
    	
    }*/
    
    public static void main(String as[]){
    	String s = "Tue May 27 19:53:39 IST 2014";
    	com.ibm.icu.text.SimpleDateFormat format = new com.ibm.icu.text.SimpleDateFormat();
    	try {

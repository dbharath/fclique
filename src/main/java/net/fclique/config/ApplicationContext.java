 ...
 */
@Configuration
@ComponentScan(basePackages = {"net.fclique.controller",
        "net.fclique.service"})
...
public class ApplicationContext {
   ...
   /* @Bean
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
      ...
      lemfb.setPackagesToScan(environment.getRequiredProperty(PROPERTY_NAME_ENTITYMANAGER_PACKAGES_TO_SCAN));
      ...
      lemfb.setJpaProperties(jpaProterties);

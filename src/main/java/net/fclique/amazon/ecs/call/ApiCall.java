...
import net.fclique.amazon.ecs.InterfaceDecorator;
import net.fclique.amazon.ecs.ProductAdvertisingAPI;
import net.fclique.amazon.ecs.ProductAdvertisingAPI.Boolean;
import net.fclique.amazon.ecs.exception.RequestErrorException;

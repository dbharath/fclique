...
import net.fclique.constants.Constants;
import net.fclique.constants.Constants.SearchType;
import net.fclique.constants.Constants.SiteEnum;
import net.fclique.crowler.service.ServiceFactory;
import net.fclique.utils.ListUtil;
